...
Quantum.DOM.getDocumentScroll = function(doc) {
    if (!Quantum.DOM.$$_documentScroll) {
        Quantum.DOM.$$_documentScroll = new Quantum.Mutable(Bricks.DOM.getDocumentScroll(doc));
...
Quantum.DOM.getViewportSize = function(doc) {
    if (!Quantum.DOM.$$_viewportSize) {
        Quantum.DOM.$$_viewportSize = new Quantum.Mutable(Bricks.DOM.getViewportSize(doc));
